...
| ID | P | Item | Milestone |
|---|---|---|---|
| DEBT-001 | **P0** partly cleared | ~~No automated tests anywhere (9,628 lines)~~ — 140 tests as of 2026-07-26: `iv_engine` at 100%, the journal P&L maths, and a scanner golden net. **Still bare:** `db.py`, `collector.py`, `schwab_client.py`, and the rest of `app.py`. | M1 |
