...
| DEBT-002 | **P0** | `app.py` is a **4,283**-line procedural script (757 lines CSS, 257 top-level statements) | M2 |
| | | *Re-measured 2026-07-29: it was 4,230 when the audit counted it and has grown ~50 lines since. The file is still accreting while we plan around it — that is the argument for M2, not a footnote to it.* | |
