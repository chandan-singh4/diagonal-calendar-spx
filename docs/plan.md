...
**Status: started 2026-08-09. 3.1, 3.2, 3.4, 3.6, 3.7, 3.8 and 3.9 are done; ONE task remains —
3.3, the migration framework. 3.5 is Chandan's call** — he considers the alerting need already met by
...
1. **M3 is nearly done — only 3.3 remains; 3.6, 3.7, 3.8 and 3.9 landed 2026-09-03, 3.5 is Chandan's call.** 3.1, 3.2, the entry-IV gate
